...
def set_total_win_event(gamestate):
...
def set_tumble_win_event(gamestate):
...
def win_event(gamestate, include_padding_index=True):
    """
...
def set_final_win_event(gamestate):
